...
const TabNavigator = () => {
	return (
		<Tab.Navigator>
			<Tab.Screen name="Chat" component={ChatListScreen} options={{ headerShown: false, title: '' }} />
			<Tab.Screen name="Settings" component={ChatSettingsScreen} options={{ headerShown: false }} />
		</Tab.Navigator>
	)
}
